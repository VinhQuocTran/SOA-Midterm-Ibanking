...
from microservices.tuition_payment.myapp.models.tuition_fee import *
import os
...
# Create semesters
semester1 = Semester(name='Spring-2024', from_date=datetime(2024, 3, 1), to_date=datetime(2024, 5, 31))
semester2 = Semester(name='Winter-2023', from_date=datetime(2023, 12, 1), to_date=datetime(2024, 2, 28))
...
course_in_semester2 = CourseInSemester(fee=500, course_id=course2.id, semester_id=semester1.id)
course_in_semester3 = CourseInSemester(fee=800, course_id=course3.id, semester_id=semester1.id)
course_in_semester4 = CourseInSemester(fee=200, course_id=course4.id, semester_id=semester1.id)

# Winter semester
course_in_semester5 = CourseInSemester(fee=800, course_id=course3.id, semester_id=semester2.id)
